...
// Controller is the glue between the view (FXML file) and logic of application
// Contains methods that are called when certain actions are performed, update the view based on logic
public class HelloController {
    @FXML // Injects the Label element from the FXML file into the controller,
    // ref fx:id attribute set to welcomeText, allows controller to interact with label element
...
Elementum nibh tellus molestie nunc non blandit massa.""");
    ...
    //@FXML // Called when the Button element is clicked, set text of Label element to Welcome to JavaFX Application
    //protected void onHelloButtonClick() {
        //welcomeText.setText("Welcome to JavaFX Application!");}

    @FXML
    protected void onAgreeCheckBoxClick(){
        boolean accepted  = agreeCheckBox.isSelected(); //Bind method to CheckBox element in hello-view.fxml
